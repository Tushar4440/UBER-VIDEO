...
async function getFare(pickup, destination) {
    ...
    const fare = {
        ...
        moto: Math.round(baseFare.moto + ((distanceTime.distance.value / 1000) * perKmFare.moto) + ((distanceTime.duration.value / 60) * perMinFare.moto))
    };
    return fare
}
...
//!otp generate when ride is created...
function getOtp(num) {
