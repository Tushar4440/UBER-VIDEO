...
const UserLogin = () => {
    ...
    return (
        <div className='bg-[#c4eaef] p-7 h-screen flex flex-col justify-between'>
            ...
            <div>
                <Link to='/captain-login' className='bg-[#58ae85] flex items-center justify-center text-white font-semibold mb-4 rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign in as Captain</Link>
            </div>
        </div>
    )
}
